...
import com.dalong.francyconverflow.use.Item;
import com.dalong.francyconverflow.use.MyFancyCoverFlowAdapter;
...
public class A05Activity extends BaseActivity {
        ...
        mfancyCoverFlow.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (homeFancyCoverFlow != null) {
                    Toast.makeText(A05Activity.this, homeFancyCoverFlow.getName(), Toast.LENGTH_SHORT).show();
                }
